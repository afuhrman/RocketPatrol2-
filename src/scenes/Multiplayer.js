...
// add rocket (p1)
//this.p1Rocket = new Rocket(this, game.config.width/2, game.config.height - borderUISize - borderPadding, 'RocketB', keyLEFT, keyRIGHT).setOrigin(0.5, 0);
//this.p2Rocket = new Rocket(this, game.config.width/2, game.config.height - borderUISize - borderPadding, 'RocketB', keyA, keyD).setOrigin(0.5, 0);
// define keys
 // add spaceships (x3)
...
this.p1Rocket = new Rocket(this, game.config.width/2, game.config.height - borderUISize - borderPadding, 'RocketB', keyLEFT, keyRIGHT).setOrigin(0.5, 0);
this.p2Rocket = new Rocket2(this, game.config.width/2, game.config.height - borderUISize - borderPadding, 'RocketB', keyA, keyD).setOrigin(0.5, 0); // Source: Jim Whitehead, CMPM 120 (Lecture 9)
this.anims.create({
    key: 'explode',
